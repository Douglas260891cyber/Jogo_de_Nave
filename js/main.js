...
const start = () => {
    ...
    //Executa uma música de fundo continuamente
    ...
    function gameOver() {
        ...
        $("#fim").html("<h1> Game Over </h1><p>Sua pontuação foi: " + pontos + "</p>" + "<div id='reinicia' onClick=reiniciaJogo()><button class='reinicia-jogo'><h3>Jogar Novamente</h3></button></div>");
    }
}
